...
<div id="conteudo">
	...
	<h2>Encontre a receita desejada:</h2>
		<form name="form_acesso" method="post" action="relatorioPaginacaoProduto.php">
		  <table>
			<tr> 
			  <td>Nome do Produto: <input name="pagina" type="text" id="filtro" size="30" maxlength="30"></td>
			</tr>
			<tr>
